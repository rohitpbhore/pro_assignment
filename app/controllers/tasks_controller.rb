class TasksController < ApplicationController
  ...
  # GET /tasks.json
  def index
    @tasks = current_user.role?('developer') ? current_user.tasks.where(:project_id => @project.id) : @project.tasks
  end
  ...
  private
    ...
    def task_params
      params.require(:task).permit(:name, :description, :project_id, :status, :user_id)
    end
end
